...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String, List<StuffListResponse>> ChildItem;


    public ExpandableListAdapter(Context context, List<String> ParentItem,
                                 HashMap<String, List<StuffListResponse>> ChildItem) {
    ...
    public View getChildView(int listPosition, final int expandedListPosition,
        ...
        final StuffListResponse stuffListResponse = (StuffListResponse) getChild(listPosition, expandedListPosition);
        if (convertView == null) {
        ...
        text1.setText(stuffListResponse.getStuffName() +"/ کد:"+stuffListResponse.getCode()+ "/ قیمت :" + stuffListResponse.getPrice());
        return convertView;
    }
